        ...
        <ul className="space-y-4">
          {bookings.map((b) => (
            ...
            >
              ...
              <div><strong>Date:</strong> {b.ride.date.slice(0, 10)} @ {b.ride.time}</div>
              <div><strong>Price:</strong> {b.ride.price} so'm</div>
              <div><strong>Driver:</strong> {b.ride.driver.name} {b.status === 'ACCEPTED' && (b.ride.driver.phone)}</div>
